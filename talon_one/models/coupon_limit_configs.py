...
class CouponLimitConfigs(object):
    ...
    def __init__(self, limits=None, local_vars_configuration=None):  # noqa: E501
        """CouponLimitConfigs - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def limits(self):
        """Gets the limits of this CouponLimitConfigs.  # noqa: E501
        ...
        :return: The limits of this CouponLimitConfigs.  # noqa: E501
    ...
    def limits(self, limits):
        """Sets the limits of this CouponLimitConfigs.

        Limits configuration for a coupon. These limits will override the limits set from the campaign.  **Note:** Only usable when creating a single coupon which is not tied to a specific recipient. Only per-profile limits are allowed to be configured.   # noqa: E501

        :param limits: The limits of this CouponLimitConfigs.  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CouponLimitConfigs):
            return False
