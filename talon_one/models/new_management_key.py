...
class NewManagementKey(object):
    ...
    def __init__(self, name=None, expiry_date=None, endpoints=None, id=None, created_by=None, account_id=None, created=None, key=None, local_vars_configuration=None):  # noqa: E501
