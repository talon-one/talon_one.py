...
class AddLoyaltyPointsEffectProps(object):
    ...
    def __init__(self, name=None, program_id=None, sub_ledger_id=None, value=None, desired_value=None, recipient_integration_id=None, start_date=None, expiry_date=None, transaction_uuid=None, cart_item_position=None, cart_item_sub_position=None, card_identifier=None, bundle_index=None, bundle_name=None, awaits_activation=None, validity_duration=None, local_vars_configuration=None):  # noqa: E501
        ...
        if awaits_activation is not None:
            self.awaits_activation = awaits_activation
    ...
    def awaits_activation(self):
        ...
        :rtype: bool
        """
        return self._awaits_activation

    @awaits_activation.setter
    def awaits_activation(self, awaits_activation):
        ...
        self._awaits_activation = awaits_activation
