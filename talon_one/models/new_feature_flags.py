...
class NewFeatureFlags(object):
    ...
    def __init__(self, loyalty=None, coupons_without_count=None, beta_effects=None, local_vars_configuration=None):  # noqa: E501
        """NewFeatureFlags - a model defined in OpenAPI"""  # noqa: E501
