...
class LoyaltyProgram(object):
    ...
    def __init__(self, id=None, account_id=None, name=None, title=None, description=None, subscribed_applications=None, default_validity=None, allow_subledger=None):  # noqa: E501
    ...
    def subscribed_applications(self, subscribed_applications):
        ...
        :type: list[int]
        """
        if subscribed_applications is None:
