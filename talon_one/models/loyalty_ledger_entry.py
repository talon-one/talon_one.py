...
class LoyaltyLedgerEntry(object):
    ...
    def __init__(self, created=None, program_id=None, customer_profile_id=None, card_id=None, customer_session_id=None, event_id=None, type=None, amount=None, start_date=None, expiry_date=None, name=None, sub_ledger_id=None, user_id=None, local_vars_configuration=None):  # noqa: E501
