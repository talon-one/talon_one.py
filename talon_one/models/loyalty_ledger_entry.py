...
class LoyaltyLedgerEntry(object):
    ...
    def __init__(self, created=None, program_id=None, customer_profile_id=None, card_id=None, customer_session_id=None, event_id=None, type=None, amount=None, start_date=None, expiry_date=None, name=None, sub_ledger_id=None, user_id=None, archived=None, flags=None, validity_duration=None, local_vars_configuration=None):  # noqa: E501
    ...
    def validity_duration(self):
        """Gets the validity_duration of this LoyaltyLedgerEntry.  # noqa: E501
        ...
        :return: The validity_duration of this LoyaltyLedgerEntry.  # noqa: E501
        :rtype: str
        """
    ...
    def validity_duration(self, validity_duration):
        """Sets the validity_duration of this LoyaltyLedgerEntry.

        The duration for which the points remain active, relative to the  activation date.  **Note**: This only applies to points for which `awaitsActivation` is `true` and `expiryDate` is not set.   # noqa: E501

        :param validity_duration: The validity_duration of this LoyaltyLedgerEntry.  # noqa: E501
        :type: str
        """
