...
class EventV3Connections(object):
    ...
    def __init__(self, connected_session_id=None, local_vars_configuration=None):  # noqa: E501
        """EventV3Connections - a model defined in OpenAPI"""  # noqa: E501
    ...
    def connected_session_id(self):
        """Gets the connected_session_id of this EventV3Connections.  # noqa: E501

        The ID of the session to reference. The session must be in `closed` state. Otherwise, the API call will fail.  # noqa: E501

        :return: The connected_session_id of this EventV3Connections.  # noqa: E501
        :rtype: str
        """
    ...
    def connected_session_id(self, connected_session_id):
        """Sets the connected_session_id of this EventV3Connections.

        The ID of the session to reference. The session must be in `closed` state. Otherwise, the API call will fail.  # noqa: E501

        :param connected_session_id: The connected_session_id of this EventV3Connections.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EventV3Connections):
            return False
