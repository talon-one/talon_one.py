...
class LoyaltyCard(object):
    ...
    def identifier(self, identifier):
        ...
        if (self.local_vars_configuration.client_side_validation and
                identifier is not None and not re.search(r'^[A-Za-z0-9._%+@-]+$', identifier)):  # noqa: E501
            raise ValueError(r"Invalid value for `identifier`, must be a follow pattern or equal to `/^[A-Za-z0-9._%+@-]+$/`")  # noqa: E501
    ...
    def old_card_identifier(self, old_card_identifier):
        ...
        if (self.local_vars_configuration.client_side_validation and
                old_card_identifier is not None and len(old_card_identifier) < 4):
            raise ValueError("Invalid value for `old_card_identifier`, length must be greater than or equal to `4`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                old_card_identifier is not None and not re.search(r'^[A-Za-z0-9._%+@-]+$', old_card_identifier)):  # noqa: E501
            raise ValueError(r"Invalid value for `old_card_identifier`, must be a follow pattern or equal to `/^[A-Za-z0-9._%+@-]+$/`")  # noqa: E501
    ...
    def new_card_identifier(self, new_card_identifier):
        ...
        if (self.local_vars_configuration.client_side_validation and
                new_card_identifier is not None and len(new_card_identifier) < 4):
            raise ValueError("Invalid value for `new_card_identifier`, length must be greater than or equal to `4`")  # noqa: E501
        if (self.local_vars_configuration.client_side_validation and
                new_card_identifier is not None and not re.search(r'^[A-Za-z0-9._%+@-]+$', new_card_identifier)):  # noqa: E501
            raise ValueError(r"Invalid value for `new_card_identifier`, must be a follow pattern or equal to `/^[A-Za-z0-9._%+@-]+$/`")  # noqa: E501
