...
class Ruleset(object):
    ...
    def __init__(self, id=None, created=None, campaign_id=None, user_id=None, rules=None, bindings=None, rb_version=None, activate=None, activated_at=None, local_vars_configuration=None):  # noqa: E501
