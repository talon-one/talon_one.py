...
class Ruleset(object):
    ...
    def __init__(self, id=None, created=None, user_id=None, rules=None, bindings=None, rb_version=None, activate=None, campaign_id=None, template_id=None, activated_at=None, local_vars_configuration=None):  # noqa: E501
