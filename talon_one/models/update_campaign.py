...
class UpdateCampaign(object):
    ...
    def reevaluate_on_return(self):
        """Gets the reevaluate_on_return of this UpdateCampaign.  # noqa: E501

        Indicates whether this campaign should be reevaluated when a customer returns an item.  # noqa: E501

        :return: The reevaluate_on_return of this UpdateCampaign.  # noqa: E501
        :rtype: bool
        """
    ...
    def reevaluate_on_return(self, reevaluate_on_return):
        """Sets the reevaluate_on_return of this UpdateCampaign.

        Indicates whether this campaign should be reevaluated when a customer returns an item.  # noqa: E501

        :param reevaluate_on_return: The reevaluate_on_return of this UpdateCampaign.  # noqa: E501
        :type: bool
        """
    ...
    def evaluation_group_id(self):
        """Gets the evaluation_group_id of this UpdateCampaign.  # noqa: E501

        The ID of the campaign evaluation group the campaign belongs to.  # noqa: E501

        :return: The evaluation_group_id of this UpdateCampaign.  # noqa: E501
        :rtype: int
        """
    ...
    def evaluation_group_id(self, evaluation_group_id):
        """Sets the evaluation_group_id of this UpdateCampaign.

        The ID of the campaign evaluation group the campaign belongs to.  # noqa: E501

        :param evaluation_group_id: The evaluation_group_id of this UpdateCampaign.  # noqa: E501
        :type: int
        """
    ...
    @property
    def type(self):
        """Gets the type of this UpdateCampaign.  # noqa: E501
        ...
        :return: The type of this UpdateCampaign.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this UpdateCampaign.

        The campaign type. Possible type values:   - `cartItem`: Type of campaign that can apply effects only to cart items.   - `advanced`: Type of campaign that can apply effects to customer sessions and cart items.   # noqa: E501

        :param type: The type of this UpdateCampaign.  # noqa: E501
        :type: str
        """
    ...
    def linked_store_ids(self, linked_store_ids):
        """Sets the linked_store_ids of this UpdateCampaign.

        A list of store IDs that you want to link to the campaign.  > [!note] **Note** > - Campaigns with linked store IDs will only be evaluated when there is a >   [customer session update](https://docs.talon.one/integration-api#tag/Customer-sessions/operation/updateCustomerSessionV2) >   that references a linked store. > - If you linked stores to the campaign by uploading a CSV file, you cannot use this property and it should be empty. > - Use of this property is limited to 50 stores. To link more than 50 stores, upload them via a CSV file.   # noqa: E501

        :param linked_store_ids: The linked_store_ids of this UpdateCampaign.  # noqa: E501
        :type: list[int]
        """
    ...
    def coupon_attributes(self):
        """Gets the coupon_attributes of this UpdateCampaign.  # noqa: E501

        Arbitrary properties associated with coupons in this campaign.  # noqa: E501

        :return: The coupon_attributes of this UpdateCampaign.  # noqa: E501
        :rtype: object
        """
    ...
    def coupon_attributes(self, coupon_attributes):
        """Sets the coupon_attributes of this UpdateCampaign.

        Arbitrary properties associated with coupons in this campaign.  # noqa: E501

        :param coupon_attributes: The coupon_attributes of this UpdateCampaign.  # noqa: E501
        :type: object
        """
