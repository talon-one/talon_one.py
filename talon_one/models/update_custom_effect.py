...
class UpdateCustomEffect(object):
    ...
    def subscribed_applications_ids(self):
        """Gets the subscribed_applications_ids of this UpdateCustomEffect.  # noqa: E501

        A list of the IDs of the applications that this effect is enabled for  # noqa: E501

        :return: The subscribed_applications_ids of this UpdateCustomEffect.  # noqa: E501
        :rtype: list[int]
        """
    ...
    def subscribed_applications_ids(self, subscribed_applications_ids):
        """Sets the subscribed_applications_ids of this UpdateCustomEffect.

        A list of the IDs of the applications that this effect is enabled for  # noqa: E501

        :param subscribed_applications_ids: The subscribed_applications_ids of this UpdateCustomEffect.  # noqa: E501
        :type: list[int]
        """
