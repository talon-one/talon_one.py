...
class NewInvitation(object):
    ...
    def acl(self):
        ...
        The `Access Control List` json defining the role of the user. This represents the actual access control on the user level. Use one of the following: - normal user: `{\"Role\": 0}` - admin: `{\"Role\": 127}`   # noqa: E501
