...
class RollbackReferralEffectProps(object):
    ...
    def __init__(self, value=None, local_vars_configuration=None):  # noqa: E501
        """RollbackReferralEffectProps - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RollbackReferralEffectProps):
            return False
