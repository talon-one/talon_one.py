...
class CampaignTemplate(object):
    ...
    def applications_ids(self):
        ...
        A list of the IDs of the applications that are subscribed to this campaign template. A list of the IDs of the applications that are subscribed to this campaign template.  # noqa: E501
