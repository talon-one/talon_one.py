...
class ApplicationCustomer(object):
    ...
    def __init__(self, id=None, created=None, integration_id=None, attributes=None, account_id=None, closed_sessions=None, total_sales=None, loyalty_memberships=None, audience_memberships=None, last_activity=None, advocate_integration_id=None, local_vars_configuration=None):  # noqa: E501
    ...
    def id(self):
        ...
        Unique ID for this entity. Not to be confused with the Integration ID, which is set by your integration layer and used in most endpoints. Unique ID for this entity. Not to be confused with the Integration ID, which is set by your integration layer and used in most endpoints.  # noqa: E501
    ...
    def created(self):
        ...
        The exact moment this entity was created. The exact moment this entity was created. The exact moment this entity was created. The exact moment this entity was created.  # noqa: E501
