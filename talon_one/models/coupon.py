...
class Coupon(object):
    ...
    def __init__(self, id=None, created=None, campaign_id=None, value=None, usage_limit=None, start_date=None, expiry_date=None, usage_counter=None, attributes=None, referral_id=None, recipient_integration_id=None, import_id=None, reservation=None, batch_id=None):  # noqa: E501
