...
class Coupon(object):
    ...
    def __init__(self, id=None, created=None, campaign_id=None, value=None, usage_limit=None, discount_limit=None, start_date=None, expiry_date=None, limits=None, usage_counter=None, discount_counter=None, discount_remainder=None, attributes=None, referral_id=None, recipient_integration_id=None, import_id=None, reservation=True, batch_id=None, local_vars_configuration=None):  # noqa: E501
