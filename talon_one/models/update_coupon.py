...
class UpdateCoupon(object):
    ...
    def __init__(self, usage_limit=None, discount_limit=None, start_date=None, expiry_date=None, limits=None, recipient_integration_id=None, attributes=None, local_vars_configuration=None):  # noqa: E501
