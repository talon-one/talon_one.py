...
class SetDiscountPerItemEffectProps(object):
    ...
    openapi_types = {
        ...
        'excluded_from_price_history': 'bool'
    }
    ...
    def __init__(self, name=None, value=None, position=None, sub_position=None, desired_value=None, scope=None, total_discount=None, desired_total_discount=None, bundle_index=None, bundle_name=None, targeted_item_position=None, targeted_item_sub_position=None, excluded_from_price_history=None, local_vars_configuration=None):  # noqa: E501
        ...
        self._excluded_from_price_history = None
        ...
        if excluded_from_price_history is not None:
            self.excluded_from_price_history = excluded_from_price_history
    ...
    def excluded_from_price_history(self):
        """Gets the excluded_from_price_history of this SetDiscountPerItemEffectProps.  # noqa: E501

        When set to `true`, the applied discount is excluded from the item's price history.  # noqa: E501

        :return: The excluded_from_price_history of this SetDiscountPerItemEffectProps.  # noqa: E501
        :rtype: bool
        """
        return self._excluded_from_price_history

    @excluded_from_price_history.setter
    def excluded_from_price_history(self, excluded_from_price_history):
        """Sets the excluded_from_price_history of this SetDiscountPerItemEffectProps.

        When set to `true`, the applied discount is excluded from the item's price history.  # noqa: E501

        :param excluded_from_price_history: The excluded_from_price_history of this SetDiscountPerItemEffectProps.  # noqa: E501
        :type: bool
        """

        self._excluded_from_price_history = excluded_from_price_history
