...
class RollbackAddedLoyaltyPointsEffectProps(object):
    ...
    def cart_item_sub_position(self):
        ...
        The sub-position is returned when [cart item flattening](https://docs.talon.one/docs/product/campaigns/campaign-evaluation/#flattened-cart-items) is enabled. It indicates to which item the loyalty points were rolled back, for cart items with `quantity` > 1.   # noqa: E501
    ...
    def card_identifier(self):
        ...
        The card on which these points were originally added.  # noqa: E501
