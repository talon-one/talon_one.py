...
class NewEventType(object):
    ...
    def __init__(self, application_ids=None, title=None, name=None, description=None, mime_type=None, example_payload=None, schema=None, handler_language=None, handler=None, version=None):  # noqa: E501
        """NewEventType - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(NewEventType, dict):
