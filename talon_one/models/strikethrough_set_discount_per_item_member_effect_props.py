...
class StrikethroughSetDiscountPerItemMemberEffectProps(object):
    ...
    def __init__(self, name=None, value=None, local_vars_configuration=None):  # noqa: E501
        """StrikethroughSetDiscountPerItemMemberEffectProps - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, StrikethroughSetDiscountPerItemMemberEffectProps):
            return False
