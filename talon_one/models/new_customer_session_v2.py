...
class NewCustomerSessionV2(object):
    ...
    def __init__(self, profile_id=None, coupon_codes=None, referral_code=None, loyalty_cards=None, state='open', cart_items=None, additional_costs=None, identifiers=None, attributes=None, local_vars_configuration=None):  # noqa: E501
