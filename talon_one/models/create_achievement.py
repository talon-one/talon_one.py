...
class CreateAchievement(object):
    ...
    def __init__(self, name=None, title=None, description=None, target=None, period=None, period_end_override=None, recurrence_policy=None, activation_policy=None, fixed_start_date=None, end_date=None, allow_rollback_after_completion=None, local_vars_configuration=None):  # noqa: E501
        """CreateAchievement - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def name(self):
        """Gets the name of this CreateAchievement.  # noqa: E501
        ...
        :return: The name of this CreateAchievement.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this CreateAchievement.

        The internal name of the achievement used in API requests.  **Note**: The name should start with a letter. This cannot be changed after the achievement has been created.   # noqa: E501

        :param name: The name of this CreateAchievement.  # noqa: E501
        :type: str
        """
    ...
    @property
    def title(self):
        """Gets the title of this CreateAchievement.  # noqa: E501

        The display name for the achievement in the Campaign Manager.  # noqa: E501

        :return: The title of this CreateAchievement.  # noqa: E501
        :rtype: str
        """
        return self._title
    ...
    def title(self, title):
        """Sets the title of this CreateAchievement.

        The display name for the achievement in the Campaign Manager.  # noqa: E501

        :param title: The title of this CreateAchievement.  # noqa: E501
        :type: str
        """
    ...
    def description(self):
        """Gets the description of this CreateAchievement.  # noqa: E501

        A description of the achievement.  # noqa: E501

        :return: The description of this CreateAchievement.  # noqa: E501
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this CreateAchievement.

        A description of the achievement.  # noqa: E501

        :param description: The description of this CreateAchievement.  # noqa: E501
        :type: str
        """
    ...
    @property
    def target(self):
        """Gets the target of this CreateAchievement.  # noqa: E501

        The required number of actions or the transactional milestone to complete the achievement.  # noqa: E501

        :return: The target of this CreateAchievement.  # noqa: E501
        :rtype: float
        """
        return self._target
    ...
    def target(self, target):
        """Sets the target of this CreateAchievement.

        The required number of actions or the transactional milestone to complete the achievement.  # noqa: E501

        :param target: The target of this CreateAchievement.  # noqa: E501
        :type: float
        """
    ...
    @property
    def period(self):
        """Gets the period of this CreateAchievement.  # noqa: E501
        ...
        :return: The period of this CreateAchievement.  # noqa: E501
        :rtype: str
        """
        return self._period
    ...
    def period(self, period):
        """Sets the period of this CreateAchievement.
    ...
    def period_end_override(self):
        """Gets the period_end_override of this CreateAchievement.  # noqa: E501


        :return: The period_end_override of this CreateAchievement.  # noqa: E501
        :rtype: TimePoint
        """
    ...
    def period_end_override(self, period_end_override):
        """Sets the period_end_override of this CreateAchievement.


        :param period_end_override: The period_end_override of this CreateAchievement.  # noqa: E501
        :type: TimePoint
        """
    ...
    def activation_policy(self):
        """Gets the activation_policy of this CreateAchievement.  # noqa: E501
        ...
        :return: The activation_policy of this CreateAchievement.  # noqa: E501
        :rtype: str
        """
    ...
    def activation_policy(self, activation_policy):
        """Sets the activation_policy of this CreateAchievement.

        The policy that determines how the achievement starts, ends, or resets. - `user_action`: The achievement ends or resets relative to when the customer started the achievement. - `fixed_schedule`: The achievement starts, ends, or resets for all customers following a fixed schedule.   # noqa: E501

        :param activation_policy: The activation_policy of this CreateAchievement.  # noqa: E501
        :type: str
        """
    ...
    def fixed_start_date(self):
        """Gets the fixed_start_date of this CreateAchievement.  # noqa: E501
        ...
        :return: The fixed_start_date of this CreateAchievement.  # noqa: E501
        :rtype: datetime
        """
    ...
    def fixed_start_date(self, fixed_start_date):
        """Sets the fixed_start_date of this CreateAchievement.

        The achievement's start date when `activationPolicy` is set to `fixed_schedule`.  **Note:** It must be an RFC3339 timestamp string.   # noqa: E501

        :param fixed_start_date: The fixed_start_date of this CreateAchievement.  # noqa: E501
        :type: datetime
        """
    ...
    @property
    def end_date(self):
        """Gets the end_date of this CreateAchievement.  # noqa: E501
        ...
        :return: The end_date of this CreateAchievement.  # noqa: E501
        :rtype: datetime
        """
    ...
    def end_date(self, end_date):
        """Sets the end_date of this CreateAchievement.

        The achievement's end date. If defined, customers cannot participate in the achievement after this date.  **Note:** It must be an RFC3339 timestamp string.   # noqa: E501

        :param end_date: The end_date of this CreateAchievement.  # noqa: E501
        :type: datetime
        """
    ...
    def allow_rollback_after_completion(self):
        """Gets the allow_rollback_after_completion of this CreateAchievement.  # noqa: E501

        When `true`, customer progress can be rolled back in completed achievements.  # noqa: E501

        :return: The allow_rollback_after_completion of this CreateAchievement.  # noqa: E501
        :rtype: bool
        """
    ...
    def allow_rollback_after_completion(self, allow_rollback_after_completion):
        """Sets the allow_rollback_after_completion of this CreateAchievement.

        When `true`, customer progress can be rolled back in completed achievements.  # noqa: E501

        :param allow_rollback_after_completion: The allow_rollback_after_completion of this CreateAchievement.  # noqa: E501
        :type: bool
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateAchievement):
            return False
