...
class CustomerAnalytics(object):
    ...
    def __init__(self, accepted_coupons=None, created_coupons=None, free_items=None, total_orders=None, total_discounted_orders=None, total_revenue=None, total_discounts=None):  # noqa: E501
        """CustomerAnalytics - a model defined in Swagger"""  # noqa: E501
    ...
    def total_discounted_orders(self, total_discounted_orders):
        ...
        :type: int
        """
        if total_discounted_orders is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CustomerAnalytics, dict):
