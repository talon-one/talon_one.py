...
class SSOConfig(object):
    ...
    @property
    def enforced(self):
        """Gets the enforced of this SSOConfig.  # noqa: E501

        An indication of whether single sign-on is enforced for the account. When enforced, users cannot use their email and password to sign in to Talon.One. It is not possible to change this to `false` after it is set to `true`.   # noqa: E501

        :return: The enforced of this SSOConfig.  # noqa: E501
        :rtype: bool
        """
    ...
    def enforced(self, enforced):
        """Sets the enforced of this SSOConfig.

        An indication of whether single sign-on is enforced for the account. When enforced, users cannot use their email and password to sign in to Talon.One. It is not possible to change this to `false` after it is set to `true`.   # noqa: E501

        :param enforced: The enforced of this SSOConfig.  # noqa: E501
        :type: bool
        """
        if self.local_vars_configuration.client_side_validation and enforced is None:  # noqa: E501
