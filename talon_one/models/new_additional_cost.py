...
class NewAdditionalCost(object):
    ...
    def type(self):
        ...
        The type of additional cost. The following options can be chosen: - `session`: Additional cost will be added per session, - `item`: Additional cost will be added per item, - `both`: Additional cost will be added per item and session.   # noqa: E501
