...
class LedgerInfo(object):
    ...
    def __init__(self, current_balance=None, pending_balance=None, negative_balance=None, expired_balance=None, spent_balance=None, tentative_current_balance=None, tentative_pending_balance=None, tentative_negative_balance=None, current_tier=None, points_to_next_tier=None, next_tier_name=None, local_vars_configuration=None):  # noqa: E501
    ...
    def negative_balance(self):
        """Gets the negative_balance of this LedgerInfo.  # noqa: E501

        Sum of negative points. This implies that `currentBalance` is `0`.  # noqa: E501

        :return: The negative_balance of this LedgerInfo.  # noqa: E501
        :rtype: float
        """
    ...
    def negative_balance(self, negative_balance):
        """Sets the negative_balance of this LedgerInfo.
    ...
    def tentative_negative_balance(self):
        """Gets the tentative_negative_balance of this LedgerInfo.  # noqa: E501
        ...
        :return: The tentative_negative_balance of this LedgerInfo.  # noqa: E501
        :rtype: float
        """
    ...
    def tentative_negative_balance(self, tentative_negative_balance):
        """Sets the tentative_negative_balance of this LedgerInfo.
    ...
    def next_tier_name(self):
        """Gets the next_tier_name of this LedgerInfo.  # noqa: E501

        The name of the next higher tier level in the loyalty program.  **Note**: - Returns `null` if the customer has reached the highest available tier. - Returns the lowest level tier name if the customer is not currently assigned to any tier.   # noqa: E501

        :return: The next_tier_name of this LedgerInfo.  # noqa: E501
        :rtype: str
        """
    ...
    def next_tier_name(self, next_tier_name):
        """Sets the next_tier_name of this LedgerInfo.

        The name of the next higher tier level in the loyalty program.  **Note**: - Returns `null` if the customer has reached the highest available tier. - Returns the lowest level tier name if the customer is not currently assigned to any tier.   # noqa: E501

        :param next_tier_name: The next_tier_name of this LedgerInfo.  # noqa: E501
        :type: str
        """
