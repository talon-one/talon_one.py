...
class LedgerInfo(object):
    ...
    def __init__(self, current_balance=None, pending_balance=None, negative_balance=None, expired_balance=None, spent_balance=None, tentative_current_balance=None, tentative_pending_balance=None, tentative_negative_balance=None, current_tier=None, points_to_next_tier=None, local_vars_configuration=None):  # noqa: E501
