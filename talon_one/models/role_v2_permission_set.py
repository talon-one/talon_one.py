...
class RoleV2PermissionSet(object):
    ...
    @property
    def name(self):
        """Gets the name of this RoleV2PermissionSet.  # noqa: E501

        Name of the permission set.  # noqa: E501

        :return: The name of this RoleV2PermissionSet.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this RoleV2PermissionSet.

        Name of the permission set.  # noqa: E501

        :param name: The name of this RoleV2PermissionSet.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RoleV2PermissionSet):
            return False
