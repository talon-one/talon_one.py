...
class CouponCreationJob(object):
    ...
    def is_reservation_mandatory(self):
        """Gets the is_reservation_mandatory of this CouponCreationJob.  # noqa: E501

        An indication of whether the code can be redeemed only if it has been reserved first.  # noqa: E501

        :return: The is_reservation_mandatory of this CouponCreationJob.  # noqa: E501
        :rtype: bool
        """
    ...
    def is_reservation_mandatory(self, is_reservation_mandatory):
        """Sets the is_reservation_mandatory of this CouponCreationJob.

        An indication of whether the code can be redeemed only if it has been reserved first.  # noqa: E501

        :param is_reservation_mandatory: The is_reservation_mandatory of this CouponCreationJob.  # noqa: E501
        :type: bool
        """
