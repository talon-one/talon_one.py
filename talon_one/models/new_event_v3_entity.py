...
class NewEventV3Entity(object):
    ...
    def __init__(self, integration_id=None, local_vars_configuration=None):  # noqa: E501
        """NewEventV3Entity - a model defined in OpenAPI"""  # noqa: E501
    ...
    def integration_id(self):
        """Gets the integration_id of this NewEventV3Entity.  # noqa: E501

        The unique ID of the event. Only one event with this ID can be registered.   # noqa: E501

        :return: The integration_id of this NewEventV3Entity.  # noqa: E501
        :rtype: str
        """
    ...
    def integration_id(self, integration_id):
        """Sets the integration_id of this NewEventV3Entity.

        The unique ID of the event. Only one event with this ID can be registered.   # noqa: E501

        :param integration_id: The integration_id of this NewEventV3Entity.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, NewEventV3Entity):
            return False
