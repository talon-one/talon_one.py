...
class CampaignEditedNotification(object):
    ...
    def __init__(self, campaign=None, old_campaign=None, local_vars_configuration=None):  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CampaignEditedNotification):
            return False
