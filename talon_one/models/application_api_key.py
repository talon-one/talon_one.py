...
class ApplicationAPIKey(object):
    ...
    def __init__(self, id=None, created_by=None, title=None, account_id=None, application_id=None, created=None, expires=None):  # noqa: E501
        """ApplicationAPIKey - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ApplicationAPIKey, dict):
