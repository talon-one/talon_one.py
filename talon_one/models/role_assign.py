...
class RoleAssign(object):
    ...
    def __init__(self, users=None, roles=None, local_vars_configuration=None):  # noqa: E501
        """RoleAssign - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RoleAssign):
            return False
