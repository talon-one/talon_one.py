...
class AchievementProgress(object):
    ...
    def achievement_id(self):
        """Gets the achievement_id of this AchievementProgress.  # noqa: E501

        The internal ID of the achievement.  # noqa: E501

        :return: The achievement_id of this AchievementProgress.  # noqa: E501
        :rtype: int
        """
    ...
    def achievement_id(self, achievement_id):
        """Sets the achievement_id of this AchievementProgress.

        The internal ID of the achievement.  # noqa: E501

        :param achievement_id: The achievement_id of this AchievementProgress.  # noqa: E501
        :type: int
        """
    ...
    @property
    def name(self):
        """Gets the name of this AchievementProgress.  # noqa: E501

        The internal name of the achievement used in API requests.   # noqa: E501

        :return: The name of this AchievementProgress.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this AchievementProgress.

        The internal name of the achievement used in API requests.   # noqa: E501

        :param name: The name of this AchievementProgress.  # noqa: E501
        :type: str
        """
    ...
    @property
    def title(self):
        """Gets the title of this AchievementProgress.  # noqa: E501

        The display name of the achievement in the Campaign Manager.  # noqa: E501

        :return: The title of this AchievementProgress.  # noqa: E501
        :rtype: str
        """
        return self._title
    ...
    def title(self, title):
        """Sets the title of this AchievementProgress.

        The display name of the achievement in the Campaign Manager.  # noqa: E501

        :param title: The title of this AchievementProgress.  # noqa: E501
        :type: str
        """
    ...
    def campaign_id(self):
        """Gets the campaign_id of this AchievementProgress.  # noqa: E501

        The ID of the campaign the achievement belongs to.  # noqa: E501

        :return: The campaign_id of this AchievementProgress.  # noqa: E501
        :rtype: int
        """
    ...
    def campaign_id(self, campaign_id):
        """Sets the campaign_id of this AchievementProgress.

        The ID of the campaign the achievement belongs to.  # noqa: E501

        :param campaign_id: The campaign_id of this AchievementProgress.  # noqa: E501
        :type: int
        """
    ...
    def status(self, status):
        ...
        allowed_values = ["inprogress", "completed", "expired"]  # noqa: E501
    ...
    @property
    def target(self):
        """Gets the target of this AchievementProgress.  # noqa: E501

        The required number of actions or the transactional milestone to complete the achievement.  # noqa: E501

        :return: The target of this AchievementProgress.  # noqa: E501
        :rtype: float
        """
        return self._target
    ...
    def target(self, target):
        """Sets the target of this AchievementProgress.

        The required number of actions or the transactional milestone to complete the achievement.  # noqa: E501

        :param target: The target of this AchievementProgress.  # noqa: E501
        :type: float
        """
