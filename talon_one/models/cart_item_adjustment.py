...
class CartItemAdjustment(object):
    ...
    def __init__(self, pay_from_loyalty_program=None, point_payment=None, remaining_price=None):  # noqa: E501
        """CartItemAdjustment - a model defined in Swagger"""  # noqa: E501
    ...
    def pay_from_loyalty_program(self, pay_from_loyalty_program):
        ...
        :type: int
        """
        if pay_from_loyalty_program is None:
    ...
    def point_payment(self, point_payment):
        ...
        :type: int
        """
        if point_payment is None:
            raise ValueError("Invalid value for `point_payment`, must not be `None`")  # noqa: E501
        if point_payment is not None and point_payment < 1:  # noqa: E501
    ...
    def remaining_price(self, remaining_price):
        ...
        :type: float
        """
        if remaining_price is not None and remaining_price < 0:  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CartItemAdjustment, dict):
