...
class Account(object):
    ...
    def state(self):
        ...
        State of the account (trial, active, trial_expired)  # noqa: E501
    ...
    def state(self, state):
        ...
        allowed_values = ["trial", "active", "trial_expired"]  # noqa: E501
    ...
    def campaigns_active_count(self, campaigns_active_count):
        ...
        :type: int
        """
        if campaigns_active_count is None:
    ...
    def campaigns_inactive_count(self, campaigns_inactive_count):
        ...
        :type: int
        """
        if campaigns_inactive_count is None:
