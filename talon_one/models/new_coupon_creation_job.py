...
class NewCouponCreationJob(object):
    ...
    def __init__(self, usage_limit=None, discount_limit=None, start_date=None, expiry_date=None, number_of_coupons=None, coupon_settings=None, attributes=None, local_vars_configuration=None):  # noqa: E501
