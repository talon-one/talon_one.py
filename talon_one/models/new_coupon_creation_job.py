...
class NewCouponCreationJob(object):
    ...
    def __init__(self, usage_limit=None, discount_limit=None, reservation_limit=None, start_date=None, expiry_date=None, number_of_coupons=None, coupon_settings=None, attributes=None, is_reservation_mandatory=False, local_vars_configuration=None):  # noqa: E501
    ...
    def is_reservation_mandatory(self):
        """Gets the is_reservation_mandatory of this NewCouponCreationJob.  # noqa: E501

        An indication of whether the code can be redeemed only if it has been reserved first.  # noqa: E501

        :return: The is_reservation_mandatory of this NewCouponCreationJob.  # noqa: E501
        :rtype: bool
        """
    ...
    def is_reservation_mandatory(self, is_reservation_mandatory):
        """Sets the is_reservation_mandatory of this NewCouponCreationJob.

        An indication of whether the code can be redeemed only if it has been reserved first.  # noqa: E501

        :param is_reservation_mandatory: The is_reservation_mandatory of this NewCouponCreationJob.  # noqa: E501
        :type: bool
        """
