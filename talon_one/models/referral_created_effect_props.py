...
class ReferralCreatedEffectProps(object):
    ...
    def __init__(self, value=None, local_vars_configuration=None):  # noqa: E501
        """ReferralCreatedEffectProps - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ReferralCreatedEffectProps):
            return False
