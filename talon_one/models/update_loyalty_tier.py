...
class UpdateLoyaltyTier(object):
    ...
    def __init__(self, name=None, min_points=None, local_vars_configuration=None):  # noqa: E501
        """UpdateLoyaltyTier - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def name(self):
        """Gets the name of this UpdateLoyaltyTier.  # noqa: E501

        The name of the tier  # noqa: E501

        :return: The name of this UpdateLoyaltyTier.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this UpdateLoyaltyTier.

        The name of the tier  # noqa: E501

        :param name: The name of this UpdateLoyaltyTier.  # noqa: E501
        :type: str
        """
    ...
    @property
    def min_points(self):
        """Gets the min_points of this UpdateLoyaltyTier.  # noqa: E501

        The minimum amount of points required to be eligible for the tier  # noqa: E501

        :return: The min_points of this UpdateLoyaltyTier.  # noqa: E501
        :rtype: float
        """
    ...
    def min_points(self, min_points):
        """Sets the min_points of this UpdateLoyaltyTier.

        The minimum amount of points required to be eligible for the tier  # noqa: E501

        :param min_points: The min_points of this UpdateLoyaltyTier.  # noqa: E501
        :type: float
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateLoyaltyTier):
            return False
