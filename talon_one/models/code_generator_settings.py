...
class CodeGeneratorSettings(object):
    ...
    def __init__(self, valid_characters=None, coupon_pattern=None):  # noqa: E501
        """CodeGeneratorSettings - a model defined in Swagger"""  # noqa: E501
    ...
    def coupon_pattern(self, coupon_pattern):
        ...
        :type: str
        """
        if coupon_pattern is None:
            raise ValueError("Invalid value for `coupon_pattern`, must not be `None`")  # noqa: E501
        if coupon_pattern is not None and len(coupon_pattern) < 3:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CodeGeneratorSettings, dict):
