...
class CodeGeneratorSettings(object):
    ...
    def coupon_pattern(self, coupon_pattern):
        ...
        if (self.local_vars_configuration.client_side_validation and
                coupon_pattern is not None and not re.search(r'^[A-Za-z0-9._%+@#-]+$', coupon_pattern)):  # noqa: E501
            raise ValueError(r"Invalid value for `coupon_pattern`, must be a follow pattern or equal to `/^[A-Za-z0-9._%+@#-]+$/`")  # noqa: E501
