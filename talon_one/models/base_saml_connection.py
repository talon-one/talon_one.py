...
class BaseSamlConnection(object):
    ...
    def __init__(self, account_id=None, name=None, enabled=None, issuer=None, sign_on_url=None, sign_out_url=None, metadata_url=None, audience_uri=None):  # noqa: E501
        """BaseSamlConnection - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(BaseSamlConnection, dict):
