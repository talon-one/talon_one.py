...
class CustomerSessionV2(object):
    ...
    def __init__(self, id=None, created=None, integration_id=None, application_id=None, profile_id=None, store_integration_id=None, evaluable_campaign_ids=None, coupon_codes=None, referral_code=None, loyalty_cards=None, state='open', cart_items=None, experiment_variant_allocations=None, additional_costs=None, identifiers=None, attributes=None, first_session=None, update_count=None, total=None, cart_item_total=None, additional_cost_total=None, updated=None, local_vars_configuration=None):  # noqa: E501
        ...
        if experiment_variant_allocations is not None:
            self.experiment_variant_allocations = experiment_variant_allocations
    ...
    @property
    def experiment_variant_allocations(self):
        """Gets the experiment_variant_allocations of this CustomerSessionV2.  # noqa: E501

        The experiment variant allocations to add to this session.   # noqa: E501

        :return: The experiment_variant_allocations of this CustomerSessionV2.  # noqa: E501
        :rtype: list[ExperimentVariantAllocation]
        """
        return self._experiment_variant_allocations

    @experiment_variant_allocations.setter
    def experiment_variant_allocations(self, experiment_variant_allocations):
        """Sets the experiment_variant_allocations of this CustomerSessionV2.

        The experiment variant allocations to add to this session.   # noqa: E501

        :param experiment_variant_allocations: The experiment_variant_allocations of this CustomerSessionV2.  # noqa: E501
        :type: list[ExperimentVariantAllocation]
        """

        self._experiment_variant_allocations = experiment_variant_allocations
    ...
    def update_count(self):
        """Gets the update_count of this CustomerSessionV2.  # noqa: E501

        The number of times the session was updated. When the session is created, this value is initialized to `1`.  # noqa: E501

        :return: The update_count of this CustomerSessionV2.  # noqa: E501
        :rtype: int
        """
    ...
    def update_count(self, update_count):
        """Sets the update_count of this CustomerSessionV2.

        The number of times the session was updated. When the session is created, this value is initialized to `1`.  # noqa: E501

        :param update_count: The update_count of this CustomerSessionV2.  # noqa: E501
        :type: int
        """
        if self.local_vars_configuration.client_side_validation and update_count is None:  # noqa: E501
