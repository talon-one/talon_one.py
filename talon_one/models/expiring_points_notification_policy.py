...
class ExpiringPointsNotificationPolicy(object):
    ...
    @property
    def name(self):
        """Gets the name of this ExpiringPointsNotificationPolicy.  # noqa: E501

        Notification name.  # noqa: E501

        :return: The name of this ExpiringPointsNotificationPolicy.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this ExpiringPointsNotificationPolicy.

        Notification name.  # noqa: E501

        :param name: The name of this ExpiringPointsNotificationPolicy.  # noqa: E501
        :type: str
        """
    ...
    @property
    def triggers(self):
        """Gets the triggers of this ExpiringPointsNotificationPolicy.  # noqa: E501


        :return: The triggers of this ExpiringPointsNotificationPolicy.  # noqa: E501
        :rtype: list[ExpiringPointsNotificationTrigger]
        """
        return self._triggers

    @triggers.setter
    def triggers(self, triggers):
        """Sets the triggers of this ExpiringPointsNotificationPolicy.


        :param triggers: The triggers of this ExpiringPointsNotificationPolicy.  # noqa: E501
        :type: list[ExpiringPointsNotificationTrigger]
        """
    ...
    @property
    def batch_size(self):
        """Gets the batch_size of this ExpiringPointsNotificationPolicy.  # noqa: E501

        The required size of each batch of data. This value applies only when `batchingEnabled` is `true`.  # noqa: E501

        :return: The batch_size of this ExpiringPointsNotificationPolicy.  # noqa: E501
        :rtype: int
        """
    ...
    def batch_size(self, batch_size):
        """Sets the batch_size of this ExpiringPointsNotificationPolicy.

        The required size of each batch of data. This value applies only when `batchingEnabled` is `true`.  # noqa: E501

        :param batch_size: The batch_size of this ExpiringPointsNotificationPolicy.  # noqa: E501
        :type: int
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ExpiringPointsNotificationPolicy):
            return False
