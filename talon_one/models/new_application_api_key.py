...
class NewApplicationAPIKey(object):
    ...
    def __init__(self, title=None, expires=None, platform=None, id=None, created_by=None, account_id=None, application_id=None, created=None, key=None, local_vars_configuration=None):  # noqa: E501
