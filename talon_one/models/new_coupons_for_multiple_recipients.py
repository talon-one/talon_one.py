...
class NewCouponsForMultipleRecipients(object):
    ...
    def __init__(self, usage_limit=None, discount_limit=None, start_date=None, expiry_date=None, attributes=None, recipients_integration_ids=None, valid_characters=None, coupon_pattern=None, local_vars_configuration=None):  # noqa: E501
