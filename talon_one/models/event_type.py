...
class EventType(object):
    ...
    def __init__(self, id=None, created=None, application_ids=None, title=None, name=None, description=None, mime_type=None, example_payload=None, schema=None, handler_language=None, handler=None, version=None, local_vars_configuration=None):  # noqa: E501
