...
class NewLoyaltyProgram(object):
    ...
    def __init__(self, name=None, title=None, description=None, subscribed_applications=None, default_validity=None, allow_subledger=None):  # noqa: E501
        """NewLoyaltyProgram - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(NewLoyaltyProgram, dict):
