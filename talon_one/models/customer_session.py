...
class CustomerSession(object):
    ...
    def __init__(self, integration_id=None, created=None, application_id=None, profile_id=None, coupon=None, referral=None, state='open', cart_items=None, identifiers=None, total=None, attributes=None, first_session=None, update_count=None, discounts=None, updated=None, local_vars_configuration=None):  # noqa: E501
    ...
    def update_count(self):
        """Gets the update_count of this CustomerSession.  # noqa: E501

        The number of times the session was updated. When the session is created, this value is initialized to `1`.  # noqa: E501

        :return: The update_count of this CustomerSession.  # noqa: E501
        :rtype: int
        """
    ...
    def update_count(self, update_count):
        """Sets the update_count of this CustomerSession.

        The number of times the session was updated. When the session is created, this value is initialized to `1`.  # noqa: E501

        :param update_count: The update_count of this CustomerSession.  # noqa: E501
        :type: int
        """
