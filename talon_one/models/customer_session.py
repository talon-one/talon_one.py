...
class CustomerSession(object):
    ...
    def __init__(self, integration_id=None, created=None, application_id=None, profile_id=None, coupon=None, referral=None, state='open', cart_items=None, identifiers=None, total=None, attributes=None, first_session=None, discounts=None):  # noqa: E501
        """CustomerSession - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CustomerSession, dict):
