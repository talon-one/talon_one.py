...
class LedgerPointsEntryIntegrationAPI(object):
    ...
    def __init__(self, id=None, transaction_uuid=None, created=None, program_id=None, customer_session_id=None, name=None, start_date=None, expiry_date=None, subledger_id=None, amount=None, validity_duration=None, local_vars_configuration=None):  # noqa: E501
    ...
    def transaction_uuid(self):
        """Gets the transaction_uuid of this LedgerPointsEntryIntegrationAPI.  # noqa: E501

        Unique identifier of the transaction in the UUID format.  # noqa: E501

        :return: The transaction_uuid of this LedgerPointsEntryIntegrationAPI.  # noqa: E501
        :rtype: str
        """
    ...
    def transaction_uuid(self, transaction_uuid):
        """Sets the transaction_uuid of this LedgerPointsEntryIntegrationAPI.

        Unique identifier of the transaction in the UUID format.  # noqa: E501

        :param transaction_uuid: The transaction_uuid of this LedgerPointsEntryIntegrationAPI.  # noqa: E501
        :type: str
        """
    ...
    def validity_duration(self):
        """Gets the validity_duration of this LedgerPointsEntryIntegrationAPI.  # noqa: E501
        ...
        :return: The validity_duration of this LedgerPointsEntryIntegrationAPI.  # noqa: E501
        :rtype: str
        """
    ...
    def validity_duration(self, validity_duration):
        """Sets the validity_duration of this LedgerPointsEntryIntegrationAPI.

        The duration for which the points remain active, relative to the  activation date.  **Note**: This only applies to points for which `awaitsActivation` is `true` and `expiryDate` is not set.   # noqa: E501

        :param validity_duration: The validity_duration of this LedgerPointsEntryIntegrationAPI.  # noqa: E501
        :type: str
        """
