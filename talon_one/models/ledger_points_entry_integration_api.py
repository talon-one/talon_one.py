...
class LedgerPointsEntryIntegrationAPI(object):
    ...
    def __init__(self, id=None, transaction_uuid=None, created=None, program_id=None, customer_session_id=None, name=None, start_date=None, expiry_date=None, subledger_id=None, amount=None, local_vars_configuration=None):  # noqa: E501
