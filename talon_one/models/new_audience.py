...
class NewAudience(object):
    ...
    def __init__(self, name=None, sandbox=None, description=None, integration=None, integration_id=None, created_in3rd_party=None, local_vars_configuration=None):  # noqa: E501
