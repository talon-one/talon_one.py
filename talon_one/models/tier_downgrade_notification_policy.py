...
class TierDowngradeNotificationPolicy(object):
    ...
    @property
    def batch_size(self):
        """Gets the batch_size of this TierDowngradeNotificationPolicy.  # noqa: E501

        The required size of each batch of data. This value applies only when `batchingEnabled` is `true`.  # noqa: E501

        :return: The batch_size of this TierDowngradeNotificationPolicy.  # noqa: E501
        :rtype: int
        """
    ...
    def batch_size(self, batch_size):
        """Sets the batch_size of this TierDowngradeNotificationPolicy.

        The required size of each batch of data. This value applies only when `batchingEnabled` is `true`.  # noqa: E501

        :param batch_size: The batch_size of this TierDowngradeNotificationPolicy.  # noqa: E501
        :type: int
        """
