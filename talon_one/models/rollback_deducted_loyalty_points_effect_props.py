...
class RollbackDeductedLoyaltyPointsEffectProps(object):
    ...
    def __init__(self, program_id=None, sub_ledger_id=None, value=None, recipient_integration_id=None, start_date=None, expiry_date=None, transaction_uuid=None, card_identifier=None, local_vars_configuration=None):  # noqa: E501
        """RollbackDeductedLoyaltyPointsEffectProps - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def program_id(self):
        """Gets the program_id of this RollbackDeductedLoyaltyPointsEffectProps.  # noqa: E501

        The ID of the loyalty program where these points were reimbursed.  # noqa: E501

        :return: The program_id of this RollbackDeductedLoyaltyPointsEffectProps.  # noqa: E501
        :rtype: int
        """
    ...
    def program_id(self, program_id):
        """Sets the program_id of this RollbackDeductedLoyaltyPointsEffectProps.

        The ID of the loyalty program where these points were reimbursed.  # noqa: E501

        :param program_id: The program_id of this RollbackDeductedLoyaltyPointsEffectProps.  # noqa: E501
        :type: int
        """
    ...
    def sub_ledger_id(self):
        """Gets the sub_ledger_id of this RollbackDeductedLoyaltyPointsEffectProps.  # noqa: E501

        The ID of the subledger within the loyalty program where these points were reimbursed.  # noqa: E501

        :return: The sub_ledger_id of this RollbackDeductedLoyaltyPointsEffectProps.  # noqa: E501
        :rtype: str
        """
    ...
    def sub_ledger_id(self, sub_ledger_id):
        """Sets the sub_ledger_id of this RollbackDeductedLoyaltyPointsEffectProps.

        The ID of the subledger within the loyalty program where these points were reimbursed.  # noqa: E501

        :param sub_ledger_id: The sub_ledger_id of this RollbackDeductedLoyaltyPointsEffectProps.  # noqa: E501
        :type: str
        """
    ...
    def recipient_integration_id(self):
        """Gets the recipient_integration_id of this RollbackDeductedLoyaltyPointsEffectProps.  # noqa: E501

        The user for whom these points were reimbursed.  # noqa: E501

        :return: The recipient_integration_id of this RollbackDeductedLoyaltyPointsEffectProps.  # noqa: E501
        :rtype: str
        """
    ...
    def recipient_integration_id(self, recipient_integration_id):
        """Sets the recipient_integration_id of this RollbackDeductedLoyaltyPointsEffectProps.

        The user for whom these points were reimbursed.  # noqa: E501

        :param recipient_integration_id: The recipient_integration_id of this RollbackDeductedLoyaltyPointsEffectProps.  # noqa: E501
        :type: str
        """
    ...
    def card_identifier(self):
        """Gets the card_identifier of this RollbackDeductedLoyaltyPointsEffectProps.  # noqa: E501

        The identifier of the loyalty card, which must match the regular expression `^[A-Za-z0-9._%+@-]+$`.   # noqa: E501

        :return: The card_identifier of this RollbackDeductedLoyaltyPointsEffectProps.  # noqa: E501
        :rtype: str
        """
    ...
    def card_identifier(self, card_identifier):
        """Sets the card_identifier of this RollbackDeductedLoyaltyPointsEffectProps.

        The identifier of the loyalty card, which must match the regular expression `^[A-Za-z0-9._%+@-]+$`.   # noqa: E501

        :param card_identifier: The card_identifier of this RollbackDeductedLoyaltyPointsEffectProps.  # noqa: E501
        :type: str
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RollbackDeductedLoyaltyPointsEffectProps):
            return False
