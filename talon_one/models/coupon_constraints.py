...
class CouponConstraints(object):
    ...
    def __init__(self, usage_limit=None, discount_limit=None, reservation_limit=None, start_date=None, expiry_date=None, local_vars_configuration=None):  # noqa: E501
        """CouponConstraints - a model defined in OpenAPI"""  # noqa: E501
    ...
    def usage_limit(self):
        """Gets the usage_limit of this CouponConstraints.  # noqa: E501
        ...
        :return: The usage_limit of this CouponConstraints.  # noqa: E501
        :rtype: int
        """
    ...
    def usage_limit(self, usage_limit):
        """Sets the usage_limit of this CouponConstraints.

        The number of times the coupon code can be redeemed. `0` means unlimited redemptions but any campaign usage limits will still apply.   # noqa: E501

        :param usage_limit: The usage_limit of this CouponConstraints.  # noqa: E501
        :type: int
        """
    ...
    def discount_limit(self):
        """Gets the discount_limit of this CouponConstraints.  # noqa: E501

        The total discount value that the code can give. Typically used to represent a gift card value.   # noqa: E501

        :return: The discount_limit of this CouponConstraints.  # noqa: E501
        :rtype: float
        """
    ...
    def discount_limit(self, discount_limit):
        """Sets the discount_limit of this CouponConstraints.

        The total discount value that the code can give. Typically used to represent a gift card value.   # noqa: E501

        :param discount_limit: The discount_limit of this CouponConstraints.  # noqa: E501
        :type: float
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def reservation_limit(self):
        """Gets the reservation_limit of this CouponConstraints.  # noqa: E501

        The number of reservations that can be made with this coupon code.   # noqa: E501

        :return: The reservation_limit of this CouponConstraints.  # noqa: E501
        :rtype: int
        """
    ...
    def reservation_limit(self, reservation_limit):
        """Sets the reservation_limit of this CouponConstraints.

        The number of reservations that can be made with this coupon code.   # noqa: E501

        :param reservation_limit: The reservation_limit of this CouponConstraints.  # noqa: E501
        :type: int
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    @property
    def start_date(self):
        """Gets the start_date of this CouponConstraints.  # noqa: E501

        Timestamp at which point the coupon becomes valid.  # noqa: E501

        :return: The start_date of this CouponConstraints.  # noqa: E501
        :rtype: datetime
        """
    ...
    def start_date(self, start_date):
        """Sets the start_date of this CouponConstraints.

        Timestamp at which point the coupon becomes valid.  # noqa: E501

        :param start_date: The start_date of this CouponConstraints.  # noqa: E501
        :type: datetime
        """
    ...
    def expiry_date(self):
        """Gets the expiry_date of this CouponConstraints.  # noqa: E501

        Expiration date of the coupon. Coupon never expires if this is omitted.  # noqa: E501

        :return: The expiry_date of this CouponConstraints.  # noqa: E501
        :rtype: datetime
        """
    ...
    def expiry_date(self, expiry_date):
        """Sets the expiry_date of this CouponConstraints.

        Expiration date of the coupon. Coupon never expires if this is omitted.  # noqa: E501

        :param expiry_date: The expiry_date of this CouponConstraints.  # noqa: E501
        :type: datetime
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CouponConstraints):
            return False
