...
class NewCoupons(object):
    ...
    def __init__(self, usage_limit=None, discount_limit=None, start_date=None, expiry_date=None, limits=None, number_of_coupons=None, unique_prefix=None, attributes=None, recipient_integration_id=None, valid_characters=None, coupon_pattern=None, local_vars_configuration=None):  # noqa: E501
    ...
    def unique_prefix(self):
        ...
        **DEPRECATED** To create more than 20,000 coupons in one request, use [Create coupons asynchronously endpoint](https://docs.talon.one/management-api/#operation/createCouponsAsync).   # noqa: E501
