...
class NewCoupons(object):
    ...
    def __init__(self, usage_limit=None, start_date=None, expiry_date=None, valid_characters=None, coupon_pattern=None, number_of_coupons=None, unique_prefix=None, attributes=None, recipient_integration_id=None):  # noqa: E501
        """NewCoupons - a model defined in Swagger"""  # noqa: E501
