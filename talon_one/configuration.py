...
class Configuration(object):
    ...
    :param signing_info: Configuration parameters for HTTP signature.
        Must be an instance of talon_one.signing.HttpSigningConfiguration
    ...
    Note you can use the constants defined in the talon_one.signing module, and you can
    ...
    are not going to be modified in transit.
      ...
      conf = talon_one.Configuration(
        signing_info = talon_one.signing.HttpSigningConfiguration(
            key_id =                 'my-key-id',
