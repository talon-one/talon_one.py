...
import talon_one
from talon_one.models.campaign_created_notification import CampaignCreatedNotification  # noqa: E501
...
class TestCampaignCreatedNotification(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = talon_one.models.campaign_created_notification.CampaignCreatedNotification()  # noqa: E501
        if include_optional :
            return CampaignCreatedNotification(
                notification_type = 'CampaignNotification', 
                total_result_size = 56, 
                data = [
                    talon_one.models.campaign_created_notification_item.CampaignCreatedNotificationItem(
