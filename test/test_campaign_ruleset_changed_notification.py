...
import talon_one
from talon_one.models.campaign_ruleset_changed_notification import CampaignRulesetChangedNotification  # noqa: E501
...
class TestCampaignRulesetChangedNotification(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = talon_one.models.campaign_ruleset_changed_notification.CampaignRulesetChangedNotification()  # noqa: E501
        if include_optional :
            return CampaignRulesetChangedNotification(
                notification_type = 'CampaignNotification', 
                total_result_size = 56, 
                data = [
                    talon_one.models.campaign_ruleset_changed_notification_item.CampaignRulesetChangedNotificationItem(
