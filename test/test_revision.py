...
import talon_one
from talon_one.models.revision import Revision  # noqa: E501
...
class TestRevision(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = talon_one.models.revision.Revision()  # noqa: E501
        if include_optional :
            return Revision(
                id = 6, 
                ...
                activated_by = 56, 
                current_version = talon_one.models.revision_version.RevisionVersion(
                    id = 6, 
                    account_id = 56, 
                    application_id = 56, 
                    campaign_id = 56, 
