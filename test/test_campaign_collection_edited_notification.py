...
import talon_one
from talon_one.models.campaign_collection_edited_notification import CampaignCollectionEditedNotification  # noqa: E501
...
class TestCampaignCollectionEditedNotification(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = talon_one.models.campaign_collection_edited_notification.CampaignCollectionEditedNotification()  # noqa: E501
        if include_optional :
            return CampaignCollectionEditedNotification(
                notification_type = 'CampaignNotification', 
                total_result_size = 56, 
                data = [
                    talon_one.models.campaign_collection_edited_notification_item.CampaignCollectionEditedNotificationItem(
                        ...
                        collection = talon_one.models.collection_without_payload.CollectionWithoutPayload(
                            id = 6, 
                            created = '2020-06-10T09:05:27.993483Z', 
                            account_id = 3886, 
