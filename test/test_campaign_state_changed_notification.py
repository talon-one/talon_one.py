...
import talon_one
from talon_one.models.campaign_state_changed_notification import CampaignStateChangedNotification  # noqa: E501
...
class TestCampaignStateChangedNotification(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = talon_one.models.campaign_state_changed_notification.CampaignStateChangedNotification()  # noqa: E501
        if include_optional :
            return CampaignStateChangedNotification(
                notification_type = 'CampaignNotification', 
                total_result_size = 56, 
                data = [
                    talon_one.models.campaign_state_changed_notification_item.CampaignStateChangedNotificationItem(
