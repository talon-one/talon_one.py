...
import talon_one
from talon_one.models.experiment import Experiment  # noqa: E501
...
class TestExperiment(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = talon_one.models.experiment.Experiment()  # noqa: E501
        if include_optional :
            return Experiment(
                id = 6, 
                ...
                state = 'disabled', 
                variants = [
                    talon_one.models.experiment_variant.ExperimentVariant(
                        id = 6, 
                        created = '2020-06-10T09:05:27.993483Z', 
                        name = 'Variant A', 
                        experiment_id = 10, 
