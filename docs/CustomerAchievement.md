...
**referenced_by_campaigns** | [**list[CampaignReference]**](CampaignReference.md) | The campaigns that reference this achievement. They are sorted in ascending order by their &#x60;id&#x60;. | 
